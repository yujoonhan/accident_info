...
import com.greenart.service.JwalkingInfoService;
...
@RestController
public class JwalkingAPIController {
    @Autowired
    JwalkingInfoService service;
    
    @GetMapping("/api/accident_jwk")
    public Map<String, Object> getAccidentJwkInfo() throws Exception{
        ...
        for(int i=0; i<nList.getLength(); i++) {
            ...
            AccidentJwkInfoVO vo = new AccidentJwkInfoVO();
            ...
            // service.insertAccidentJwkInfo(vo);
        }
    ...
    @GetMapping("api/jwalking")
    public Map<String, Object> getRegionalInfo(){
        Map<String, Object> resultMap = new LinkedHashMap<String, Object>();
        List<AccidentJwkInfoVO> list = service.selectJwkCntYear();
